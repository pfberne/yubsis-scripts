...
Le script `/opt/yubsis-scripts/monitoring.py` permet d'effectuer les vérifications communes à tous les serveurs. Le crontab habituel est `0 18 * * 5 python3 /opt/yubsis-scripts/backup_check.py` pour un résumé chaque vendredi à 18h.
...
- **v1.2 - 2020-05-18 :**
  ...
  - **Mise à jour :**
    ...
    - `cp /opt/yubsis-scripts/logrotate.d/odoo /etc/logrotate.d/odoo`
- **v1.1 - 2020-05-14 :**
